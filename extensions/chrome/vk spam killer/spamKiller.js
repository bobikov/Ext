...
function banOne(){
		...
		var author = $('.author');
			for (var i = 0; i < author.length; i++){
				if(author[i].getAttribute('href')===event.target.parentNode.childNodes[0].getAttribute('href')){
					// author[i].style.cssText='background: red';
					author[i].parentNode.parentNode.parentNode.parentNode.parentNode.style.cssText='display:none';
				}
			}
